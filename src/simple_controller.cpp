#include "mobile_robot/simple_controller.hpp"
    ...
    , right_wheel_prev_pos_(0.0)
{
    ...
    RCLCPP_INFO_STREAM(get_logger(), "The conservation matrix is \n" << speed_conversion_);
...
void SimpleController::jointCallback(const sensor_msgs::msg::JointState & msg){
    ...
    RCLCPP_INFO(get_logger(), "Linear: %f Angular: %f", linear, angular);
}
